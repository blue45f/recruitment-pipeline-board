...
- Vercel: [recruitment-pipeline-board-blue45fs-projects.vercel.app](https://recruitment-pipeline-board-blue45fs-projects.vercel.app/)
- 별도 백엔드 없이 브라우저의 Mock Service Worker가 API 응답과 저장을 담당합니다.
...
- 빈 단계를 포함한 열 전체로 이동할 수 있는 포인터 드래그 앤 드롭
...
- 기능 구현과 후속 리뷰·검증 보완을 분리해 커밋하고, `PROMPTS.md`에는 같은 작업 흐름을 커밋 순서에 맞춰 기록합니다.
